...
@Data
@ApiModel
public class AppealDealRecordResponse extends ResponseParent {

    @ApiModelProperty(name = "DATA", value = "", required = true, example = "")
    @JsonProperty(value = "DATA")
    private List<AppealDealRecord> data = new ArrayList<AppealDealRecord>();

    public AppealDealRecordResponse() {
    }

    public List<AppealDealRecord> getData() {
        return data;
    }

    public void setData(List<AppealDealRecord> data) {
        this.data = data;
    }

    public AppealDealRecordResponse(Page<AppealDealRecord> pageResult) {
