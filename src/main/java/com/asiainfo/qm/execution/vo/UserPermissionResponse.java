...
@Data
@ApiModel
public class UserPermissionResponse extends ResponseParent {

	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty(value = "DATA")
	private List<UserPermission> data = new ArrayList<UserPermission>();

	public UserPermissionResponse() {}

	public List<UserPermission> getData() {
		return data;
	}

	public void setData(List<UserPermission> data) {
		this.data = data;
	}

	public UserPermissionResponse(Page<UserPermission> pageResult) {
