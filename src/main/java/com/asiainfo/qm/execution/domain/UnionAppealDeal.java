...
public class UnionAppealDeal {
    ...
    private String appealStaffName;
    ...
    private String preNodeDealStaffId;
    ...
    public String getAppealStaffId() {
        return appealStaffId;
    }

    public void setAppealStaffId(String appealStaffId) {
        this.appealStaffId = appealStaffId == null ? null : appealStaffId.trim();
    }

    public String getAppealStaffName() {
        return appealStaffName;
    }

    public void setAppealStaffName(String appealStaffName) {
        this.appealStaffName = appealStaffName == null ? null : appealStaffName.trim();
    }
    ...
    public void setMainProcessId(String mainProcessId) {
        this.mainProcessId = mainProcessId == null ? null : mainProcessId.trim();
    }
    ...
    public void setCurrentProcessId(String currentProcessId) {
        this.currentProcessId = currentProcessId == null ? null : currentProcessId.trim();
    }
    ...
    public void setPreProcessId(String preProcessId) {
        this.preProcessId = preProcessId == null ? null : preProcessId.trim();
    }
    ...
    public String getPreNodeDealStaffId() {
        return preNodeDealStaffId;
    }

    public void setPreNodeDealStaffId(String preNodeDealStaffId) {
        this.preNodeDealStaffId = preNodeDealStaffId == null ? null : preNodeDealStaffId.trim();
    }
    ...
    public void setNextProcessId(String nextProcessId) {
        this.nextProcessId = nextProcessId == null ? null : nextProcessId.trim();
    }
