...
//        calendar.setTime(DateUtil.string2Date("2019-02-25 00:00:00"));
//        Long startTime = calendar.getTimeInMillis();
//        calendar.setTime(DateUtil.string2Date("2019-02-25 23:59:59"));
...
//        calendar.setTime(DateUtil.string2Date("2019-02-25 23:59:59"));
//        Long endTime = calendar.getTimeInMillis();
        params.put("startTime","1551111456000");
        params.put("endTime","1551111696000");
        params.put("agentIds", "1009");
        params.put("entId","0251210001");
        params.put("remoteUrl", "018071089281");
        params.put("sessionIds", "2331866340463249266");
        params.put("pageNum","1");
        String ret = sendGet(url, params);
        System.out.println(ret);
    }
