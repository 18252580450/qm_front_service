...
//    //获取实例对象
//    public static SequenceUtils getKeysInstant() {
//        if (sequenceUtils == null) {
//            sequenceUtils = SpringContextUtil.getBean(SequenceUtils.class);
//        }
