...
@Data
@ApiModel
public class QmPlanResponse extends ResponseParent {

	@ApiModelProperty(name = "DATA", value = "", required = true, example = "")
	@JsonProperty(value = "DATA")
	private List<QmPlan> data = new ArrayList<QmPlan>();

	public QmPlanResponse() {}

	public List<QmPlan> getData() {
		return data;
	}

	public void setData(List<QmPlan> data) {
		this.data = data;
	}
