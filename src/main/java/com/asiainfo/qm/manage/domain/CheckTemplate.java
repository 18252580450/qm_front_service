...
public class CheckTemplate {
    ...
    private String templateRootNode;
    ...
    public void setTemplateScore(Integer templateScore) {
        this.templateScore = templateScore;
    }

    public String getTemplateRootNode() {
        return templateRootNode;
    }

    public void setTemplateRootNode(String templateRootNode) {
        this.templateRootNode = templateRootNode == null ? null : templateRootNode.trim();
    }
